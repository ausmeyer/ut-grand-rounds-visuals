...
The shared browser test also covers Slides 14–15: 11 total states at 1240 × 540, direct hashes, controls, keyboard navigation, finite paths, frame bounds, fixed plot geometry across each slide's builds, text collisions, and no external runtime requests. Slide 15 was simplified to two states on September 24, 2026. Screenshot inspection checks spacing and visual hierarchy separately. These changes have no backend or schema dependency.
